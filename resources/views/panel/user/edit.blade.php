                    ...
                    <form action="" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-6 pr-1">
                                <div class="form-group">
                                    <label>Phone</label>
                                    <input type="text" name="phone" value="{{ $getRecord->phone }}" required class="form-control">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 pr-1">
                                <div class="form-group">
                                    <label>Address</label>
                                    <input type="text" name="address" value="{{ $getRecord->address }}" required class="form-control">
                                </div>
                            </div>
                        </div>

                        @if($getRecord->role_id !== 1 && $getRecord->role_id !== 2)
                        <!-- Employment Pass (Visible only for non-Admin and non-Super Admin roles) -->
                        <div class="row">
                            <div class="col-md-6 pr-1">
                                <div class="form-group">
                                    <label>Employment Pass</label>
                                    <input type="text" name="employment_pass" value="{{ $getRecord->employment_pass }}" required class="form-control">
                                </div>
                            </div>
                        </div>

                        <!-- Passport Number (Visible only for non-Admin and non-Super Admin roles) -->
                        <div class="row">
                            <div class="col-md-6 pr-1">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="role_id" required>
                                        ...
                                        @foreach($getRole as $value)
                                            <option {{ ($getRecord->role_id == $value->id) ? 'selected' : '' }} value="{{ $value->id }}">
                                                {{ $value->name }}
                                            </option>
                                        @endforeach
                                    </select>
